...
- **Service worker:** cachenaam is `crimpify-v27`. Bumpen bij elke deploy die
  bestanden wijzigt (`crimpify-v28`, enz.), anders zien bezoekers de oude versie.
...
- Versienummer op de splash (nu v0.33) bij elke release ophogen, samen met de sw-cache.
